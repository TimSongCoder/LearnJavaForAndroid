/**
* This is a good example to dispel the confusion about class and instance initializer.
* There is some order to obey.
* After class loaded, <clinit> executed. (class initializer top-down);  for one time
* After new allocates memory for an object, <init> executed.(instance initializer top-down).maybe many times.
*/
public class InitializerDemo{
	...
	public static void main(String[] args){
		...
		System.out.println();
		for(int i = 0; i < 2; i++){
			System.out.println("About to create InitializerDemo object.");
			System.out.println();
			InitializerDemo id = new InitializerDemo();
			System.out.println("InitializerDemo instance id created.");
			System.out.println();
